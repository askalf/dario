...
- **CC drift patch** — `SUPPORTED_CC_RANGE.maxTested` bumped `2.1.128` → `2.1.131` for CC v2.1.131. Auto-drafted by `cc-drift-watch.yml`; maintainer confirm the bundled template doesn't also need a re-capture (run `node scripts/capture-and-bake.mjs` locally, amend this PR).
## [3.37.4] - 2026-05-05
