...
- **CC drift patch** — `SUPPORTED_CC_RANGE.maxTested` bumped `2.1.241` → `2.1.243` for CC v2.1.243. Auto-drafted by `cc-drift-watch.yml`. Template re-capture, if needed, is auto-handled by `cc-drift-template-watch.yml`.
## [5.5.61] - 2026-08-25
