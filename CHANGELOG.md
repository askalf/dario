...
- **CC drift patch** — `SUPPORTED_CC_RANGE.maxTested` bumped `2.1.145` → `2.1.147` for CC v2.1.147. Auto-drafted by `cc-drift-watch.yml`; maintainer confirm the bundled template doesn't also need a re-capture (run `node scripts/capture-and-bake.mjs` locally, amend this PR).
## [4.8.4] - 2026-05-19
